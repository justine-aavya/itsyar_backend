...
# ) -> User:
#     """Dependency that extracts and validates JWT, returns the current user."""
...
#         @router.get("/mentors-and-admins")
#         def mentor_route(current_user: User = Depends(require_role(["Mentor", "Admin"]))):
#             ...
#     """
